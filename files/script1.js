...
if(pin){
  if(phformat.test(pin)==true && pin>0)
  {
   document.getElementById("pin").style="border:3px solid green;"
   document.getElementById("pierror").style="display:none;"
   document.getElementById("pivalid").style="display:none;"
   document.getElementById("lgoi").style="display: inline-block;"
  PinFlag = 1;
  }
 else{
 document.getElementById("pin").style="border:3px solid red;"
 document.getElementById("pivalid").style="display:block;color:red"
 document.getElementById("pierror").style="display:none;"
 document.getElementById("lgoi").style="display: none;"
 PinFlag = 0;
 }
 }
 else{
 document.getElementById("pin").style="border:3px solid red;"
 document.getElementById("pierror").style="display:block;color:red"
 document.getElementById("pivalid").style="display:none;"
 document.getElementById("lgoi").style="display: none;"
 PinFlag = 0;
 }
